...
import com.rps.animalslistdagger2.adapters.AnimalListAdapter
...
class ListFragment : Fragment() {
    ...
    private val loadinLiveDataObserver = Observer<Boolean>{isLoading->
        ...
        if(isLoading){
            ...
            recyclerViewAnimals.visibility = View.GONE
        }
    }
    private val errorLiveData = Observer<Boolean>{isError->
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.loading.observe(this,loadinLiveDataObserver)
        viewModel.loadError.observe(this,errorLiveData)
        viewModel.refresh()
